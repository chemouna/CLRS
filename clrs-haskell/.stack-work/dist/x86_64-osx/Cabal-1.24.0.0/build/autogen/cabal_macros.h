...
/* package clrs-haskell-0.1.0.0 */
#define VERSION_clrs_haskell "0.1.0.0"
#define MIN_VERSION_clrs_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "clrs-haskell-0.1.0.0-HU8vgo0ndjN6cxT874GKsz"

#define CURRENT_PACKAGE_KEY "clrs-haskell-0.1.0.0-HU8vgo0ndjN6cxT874GKsz"
